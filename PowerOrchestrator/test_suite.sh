...
check_syntax "openwrt/homelab_config_sync.sh" "sh"
check_syntax "openwrt/homelab_notify.sh" "sh"
check_syntax "openwrt/homelab_maintenance.sh" "sh"
check_syntax "openwrt/wake_listener/guest_wake_listener.sh" "sh"
check_syntax "openwrt/wake_listener/game_wake_listener.sh" "sh"
check_syntax "openwrt/power_proxy/power_proxy_daemon.sh" "sh"
check_syntax "openwrt/power_proxy/components/helper_check.sh" "sh"
check_syntax "openwrt/power_proxy/components/helper_cleanup.sh" "sh"
check_syntax "openwrt/power_proxy/components/helper_listeners.sh" "sh"
check_syntax "openwrt/power_proxy/components/helper_notify.sh" "sh"
check_syntax "openwrt/power_proxy/components/helper_redirects.sh" "sh"
check_syntax "openwrt/power_proxy/components/helper_staticArp.sh" "sh"
check_syntax "openwrt/power_proxy/components/main.sh" "sh"
check_syntax "openwrt/telegram_bot_daemon.sh" "sh"
check_syntax "openwrt/install_openwrt.sh" "sh"
check_syntax "openwrt/waking_server/cgi-bin/status" "sh"
check_syntax "openwrt/waking_server/cgi-bin/notify" "sh"
check_syntax "openwrt/waking_server/cgi-bin/utils.sh" "sh"
