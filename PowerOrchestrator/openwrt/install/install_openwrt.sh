...
# Load helper
. "$(dirname "$0")"/../components/packages_helper.sh
. "$(dirname "$0")"/components/setup_conf_helper.sh
. "$(dirname "$0")"/components/script_helper.sh
. "$(dirname "$0")"/components/service_helper.sh
. "$(dirname "$0")"/components/post_install_helper.sh
